...
namespace AbstractRepairWorkServiceImplementDataBase.Implementations
{
    public class ReportServiceDB: IReportService
    {
        ...
        public ReportServiceDB(AbstractRepairDbContext context)
        {
            ...
            try
            {
               ...
               missing, ref missing);
                ...
                for (int i = 0; i < repairs.Count; ++i)
                {
                    ...
                    table.Cell(i + 1, 2).Range.Text = repairs[i].Cost.ToString();
                }
           ...
           .GroupJoin(
            ...
            (storage, storageCompList) =>
             new StorageLoadViewModel
             {
                 ...
                 Materials = storageCompList.Select(r => new Tuple<string,
        ...
        public List<CustomerBookingModel> GetCustomerBooking(ReportBindingModel model)
        {
           ...
           rec.CreateDate <= model.DateTo)
            .Select(rec => new CustomerBookingModel
            {
